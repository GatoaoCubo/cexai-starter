---
quality: null
id: p11_fb_lifecycle_rule
kind: builder_default
pillar: P11
title: "Feedback: Lifecycle Rule"
domain: lifecycle_rule
version: 1.1.0
tags: [feedback, anti-patterns, P11, lifecycle_rule]
8f: "F7_govern"
keywords: [lifecycle rule, never rules, failure modes, step correction, feedback, anti-patterns, lifecycle_rule, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for lifecycle rule builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
