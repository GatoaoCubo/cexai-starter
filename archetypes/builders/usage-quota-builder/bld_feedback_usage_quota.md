---
quality: null
id: p11_fb_usage_quota
kind: builder_default
pillar: P11
title: "Feedback: Usage Quota"
domain: usage_quota
version: 1.1.0
tags: [feedback, anti-patterns, P11, usage_quota]
8f: "F7_govern"
keywords: [usage quota, never rules, failure modes, step correction, feedback, anti-patterns, usage_quota, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for usage quota builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
