...
8f: "F7_govern"
keywords: [landing page, never rules, failure modes, step correction, feedback, anti-patterns, landing_page, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for landing page builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
