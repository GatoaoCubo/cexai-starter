---
quality: null
id: p11_fb_threat_model
kind: builder_default
pillar: P11
title: "Feedback: Threat Model"
domain: threat_model
version: 1.1.0
tags: [feedback, anti-patterns, P11, threat_model]
8f: "F7_govern"
keywords: [threat model, never rules, failure modes, step correction, feedback, anti-patterns, threat_model, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for threat model builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
