---
quality: null
id: p11_fb_memory_scope
kind: builder_default
pillar: P11
title: "Feedback: Memory Scope"
domain: memory_scope
version: 1.1.0
tags: [feedback, anti-patterns, P11, memory_scope]
8f: "F7_govern"
keywords: [memory scope, never rules, failure modes, step correction, feedback, anti-patterns, memory_scope, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for memory scope builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
