...
8f: "F3_inject"
keywords: [process manager orchestration, tool integrations, cli commands, and external capabilities, builder, process_manager, tools, "cex_compile.py {path}", cex_doctor.py, "cex_retriever.py --query {intent}"]
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-17"
related:
...
| [[bld_tools_alert_rule]] | sibling | 0.61 |
