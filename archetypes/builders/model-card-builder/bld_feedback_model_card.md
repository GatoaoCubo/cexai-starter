---
quality: null
id: p11_fb_model_card
kind: builder_default
pillar: P11
title: "Feedback: Model Card"
domain: model_card
version: 1.1.0
tags: [feedback, anti-patterns, P11, model_card]
8f: "F7_govern"
keywords: [model card, never rules, failure modes, step correction, feedback, anti-patterns, model_card, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for model card builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
