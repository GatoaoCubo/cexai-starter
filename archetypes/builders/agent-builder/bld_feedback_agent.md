...
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent]
8f: "F7_govern"
keywords: [never rules, failure modes, step correction, feedback, anti-patterns, agent, common failure modes, failure mode, correction protocol, key behaviors]
tldr: "Anti-patterns and correction protocol for agent builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
