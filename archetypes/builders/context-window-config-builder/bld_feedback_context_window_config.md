---
id: p11_fb_context_window_config
kind: builder_default
pillar: P11
title: "Feedback: Context Window Config"
domain: context_window_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, context_window_config]
8f: "F7_govern"
keywords: [context window config, never rules, failure modes, step correction, feedback, anti-patterns, context_window_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for context window config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
---
# Feedback: Context Window Config
...
| [[p11_fb_validation_schema]] | sibling | 0.80 |
