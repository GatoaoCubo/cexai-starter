...
pillar: P11
title: "Feedback: Agents Md"
domain: agents_md
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agents_md]
8f: "F7_govern"
keywords: [agents md, never rules, failure modes, step correction, feedback, anti-patterns, agents_md, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agents md builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
