---
quality: null
id: p11_fb_workflow_run_crate
kind: builder_default
pillar: P11
title: "Feedback: Workflow Run Crate"
domain: workflow_run_crate
version: 1.1.0
tags: [feedback, anti-patterns, P11, workflow_run_crate]
8f: "F7_govern"
keywords: [workflow run crate, never rules, failure modes, step correction, feedback, anti-patterns, workflow_run_crate, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for workflow run crate builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
|----------|-------------|-------|
| [[p11_fb_quality_gate]] | sibling | 0.80 |
| [[p11_fb_workflow]] | sibling | 0.79 |
| [[p11_fb_pattern]] | sibling | 0.79 |
| [[p11_fb_kind]] | sibling | 0.79 |
| [[p11_fb_context_file]] | sibling | 0.78 |
