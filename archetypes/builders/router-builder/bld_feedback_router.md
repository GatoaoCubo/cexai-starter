...
domain: router
version: 1.1.0
tags: [feedback, anti-patterns, P11, router]
8f: "F7_govern"
keywords: [never rules, failure modes, step correction, feedback, anti-patterns, router, common failure modes, failure mode, correction protocol, key behaviors]
tldr: "Anti-patterns and correction protocol for router builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
