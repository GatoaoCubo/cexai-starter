---
quality: null
id: p11_fb_mcp_server
kind: builder_default
pillar: P11
title: "Feedback: Mcp Server"
domain: mcp_server
version: 1.1.0
tags: [feedback, anti-patterns, P11, mcp_server]
8f: "F7_govern"
keywords: [mcp server, never rules, failure modes, step correction, feedback, anti-patterns, mcp_server, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for mcp server builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
