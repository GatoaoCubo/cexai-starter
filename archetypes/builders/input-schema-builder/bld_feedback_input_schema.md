---
id: p11_fb_input_schema
kind: builder_default
pillar: P11
title: "Feedback: Input Schema"
domain: input_schema
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, input_schema]
8f: "F7_govern"
keywords: [input schema, never rules, failure modes, step correction, feedback, anti-patterns, input_schema, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for input schema builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
