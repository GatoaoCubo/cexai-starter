...
author: builder
tldr: "Alert Rule config: tool integrations, CLI commands, and external capabilities"
8f: "F3_inject"
keywords: [alert rule config, tool integrations, cli commands, and external capabilities, builder, alert_rule, tools, "cex_compile.py {path}", cex_doctor.py, "cex_retriever.py --query {intent}"]
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-17"
related:
