---
id: p11_fb_alert_rule
kind: builder_default
pillar: P11
title: "Feedback: Alert Rule"
domain: alert_rule
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, alert_rule]
8f: "F7_govern"
keywords: [alert rule, never rules, failure modes, step correction, feedback, anti-patterns, alert_rule, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for alert rule builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
