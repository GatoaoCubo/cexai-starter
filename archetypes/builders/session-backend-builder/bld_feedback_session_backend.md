---
quality: null
id: p11_fb_session_backend
kind: builder_default
pillar: P11
title: "Feedback: Session Backend"
domain: session_backend
version: 1.1.0
tags: [feedback, anti-patterns, P11, session_backend]
8f: "F7_govern"
keywords: [session backend, never rules, failure modes, step correction, feedback, anti-patterns, session_backend, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for session backend builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
