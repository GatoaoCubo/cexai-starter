---
id: p11_fb_judge_config
kind: builder_default
pillar: P11
title: "Feedback: Judge Config"
domain: judge_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, judge_config]
8f: "F7_govern"
keywords: [judge config, never rules, failure modes, step correction, feedback, anti-patterns, judge_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for judge config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
