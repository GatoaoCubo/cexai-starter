...
updated: "2026-04-07"
8f: "F5_call"
keywords: [prompt version construction, tools prompt version, prompt_version, builder, examples, production tools, data sources, tool permissions, interim validation
...
```bash
python _tools/cex_score.py --apply bld-tools-prompt-version.md
```
...
| [[bld_tools_constraint_spec]] | sibling | 0.69 |
