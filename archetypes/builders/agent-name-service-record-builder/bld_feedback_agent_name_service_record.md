---
id: p11_fb_agent_name_service_record
kind: builder_default
pillar: P11
title: "Feedback: Agent Name Service Record"
domain: agent_name_service_record
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent_name_service_record]
8f: "F7_govern"
keywords: [agent name service record, never rules, failure modes, step correction, feedback, anti-patterns, agent_name_service_record, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agent name service record builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
