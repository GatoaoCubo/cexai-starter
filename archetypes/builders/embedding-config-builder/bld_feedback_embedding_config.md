---
id: p11_fb_embedding_config
kind: builder_default
pillar: P11
title: "Feedback: Embedding Config"
domain: embedding_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, embedding_config]
8f: "F7_govern"
keywords: [embedding config, never rules, failure modes, step correction, feedback, anti-patterns, embedding_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for embedding config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
| [[p11_fb_path_config]] | sibling | 0.80 |
