...
8f: "F3_inject"
keywords: [value object schema, tool integrations, cli commands, and external capabilities, builder, value_object, tools, "cex_compile.py {path}", cex_doctor.py, "cex_retriever.py --query {intent}"]
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-17"
related:
