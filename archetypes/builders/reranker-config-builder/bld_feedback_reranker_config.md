...
quality: null
version: 1.1.0
id: p11_fb_reranker_config
kind: builder_default
pillar: P11
title: "Feedback: Reranker Config"
domain: reranker_config
tags: [feedback, anti-patterns, P11, reranker_config]
tldr: "Reranker Config feedback: anti-patterns, regression signals, and quality improvement triggers"
8f: "F7_govern"
keywords: [reranker config, reranker config feedback, regression signals, and quality improvement triggers, feedback, anti-patterns, reranker_config, common failure modes, correction protocol, key behaviors]
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
## Common Failure Modes for Reranker Config
...
|----------|-------------|-------|
| [[p11_fb_ab_test_config]] | sibling | 0.78 |
| [[p11_fb_retriever]] | sibling | 0.77 |
| [[p11_fb_handoff]] | sibling | 0.77 |
| [[p11_fb_retriever_config]] | sibling | 0.77 |
