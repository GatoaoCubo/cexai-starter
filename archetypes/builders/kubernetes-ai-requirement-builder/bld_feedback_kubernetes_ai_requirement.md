---
quality: null
id: p11_fb_kubernetes_ai_requirement
kind: builder_default
pillar: P11
title: "Feedback: Kubernetes Ai Requirement"
domain: kubernetes_ai_requirement
version: 1.1.0
tags: [feedback, anti-patterns, P11, kubernetes_ai_requirement]
8f: "F7_govern"
keywords: [kubernetes ai requirement, never rules, failure modes, step correction, feedback, anti-patterns, kubernetes_ai_requirement, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for kubernetes ai requirement builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
related:
  ...
  - p11_fb_kind
---
# Feedback: Kubernetes Ai Requirement
