...
author: builder
tldr: "Constitutional Rule feedback: tool integrations, CLI commands, and external capabilities"
8f: "F3_inject"
keywords: [constitutional rule feedback, tool integrations, cli commands, and external capabilities, builder, constitutional_rule, tools, "cex_compile.py {path}", cex_doctor.py, "cex_retriever.py --query {intent}"]
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-17"
related:
...
| bld_tools_alert_rule | sibling | 0.64 |
