---
quality: null
id: p11_fb_voice_pipeline
kind: builder_default
pillar: P11
title: "Feedback: Voice Pipeline"
domain: voice_pipeline
version: 1.1.0
tags: [feedback, anti-patterns, P11, voice_pipeline]
8f: "F7_govern"
keywords: [voice pipeline, never rules, failure modes, step correction, feedback, anti-patterns, voice_pipeline, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for voice pipeline builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
