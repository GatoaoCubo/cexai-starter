---
id: p11_fb_agent_computer_interface
kind: builder_default
pillar: P11
title: "Feedback: Agent Computer Interface"
domain: agent_computer_interface
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent_computer_interface]
8f: "F7_govern"
keywords: [agent computer interface, never rules, failure modes, step correction, feedback, anti-patterns, agent_computer_interface, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agent computer interface builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-22"
---
# Feedback: Agent Computer Interface
