---
quality: null
id: p11_fb_runtime_state
kind: builder_default
pillar: P11
title: "Feedback: Runtime State"
domain: runtime_state
version: 1.1.0
tags: [feedback, anti-patterns, P11, runtime_state]
8f: "F7_govern"
keywords: [runtime state, never rules, failure modes, step correction, feedback, anti-patterns, runtime_state, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for runtime state builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
