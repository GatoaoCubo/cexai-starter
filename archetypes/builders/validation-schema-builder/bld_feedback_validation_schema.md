---
quality: null
id: p11_fb_validation_schema
kind: builder_default
pillar: P11
title: "Feedback: Validation Schema"
domain: validation_schema
version: 1.1.0
tags: [feedback, anti-patterns, P11, validation_schema]
8f: "F7_govern"
keywords: [validation schema, never rules, failure modes, step correction, feedback, anti-patterns, validation_schema, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for validation schema builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
