---
quality: null
id: p11_fb_pipeline_template
kind: builder_default
pillar: P11
title: "Feedback: Pipeline Template"
domain: pipeline_template
version: 1.1.0
tags: [feedback, anti-patterns, P11, pipeline_template]
8f: "F7_govern"
keywords: [pipeline template, never rules, failure modes, step correction, feedback, anti-patterns, pipeline_template, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for pipeline template builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
