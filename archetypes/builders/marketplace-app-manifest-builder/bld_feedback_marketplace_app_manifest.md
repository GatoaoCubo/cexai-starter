---
quality: null
id: p11_fb_marketplace_app_manifest
kind: builder_default
pillar: P11
title: "Feedback: Marketplace App Manifest"
domain: marketplace_app_manifest
version: 1.1.0
tags: [feedback, anti-patterns, P11, marketplace_app_manifest]
8f: "F7_govern"
keywords: [marketplace app manifest, never rules, failure modes, step correction, feedback, anti-patterns, marketplace_app_manifest, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for marketplace app manifest builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
related:
  ...
  - p11_fb_input_schema
---
# Feedback: Marketplace App Manifest
...
| [[p11_fb_input_schema]] | sibling | 0.80 |
