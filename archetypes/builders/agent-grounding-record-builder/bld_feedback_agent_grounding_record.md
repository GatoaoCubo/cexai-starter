---
id: p11_fb_agent_grounding_record
kind: builder_default
pillar: P11
title: "Feedback: Agent Grounding Record"
domain: agent_grounding_record
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent_grounding_record]
8f: "F7_govern"
keywords: [agent grounding record, never rules, failure modes, step correction, feedback, anti-patterns, agent_grounding_record, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agent grounding record builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
related:
  ...
  - p11_fb_kind
---
# Feedback: Agent Grounding Record
