---
quality: null
id: p11_fb_user_model
kind: builder_default
pillar: P11
title: "Feedback: User Model"
domain: user_model
version: 1.1.0
tags: [feedback, anti-patterns, P11, user_model]
8f: "F7_govern"
keywords: [user model, never rules, failure modes, step correction, feedback, anti-patterns, user_model, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for user model builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
