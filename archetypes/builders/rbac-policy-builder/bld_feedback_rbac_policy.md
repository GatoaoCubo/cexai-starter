---
quality: null
id: p11_fb_rbac_policy
kind: builder_default
pillar: P11
title: "Feedback: Rbac Policy"
domain: rbac_policy
version: 1.1.0
tags: [feedback, anti-patterns, P11, rbac_policy]
8f: "F7_govern"
keywords: [rbac policy, never rules, failure modes, step correction, feedback, anti-patterns, rbac_policy, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for rbac policy builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
