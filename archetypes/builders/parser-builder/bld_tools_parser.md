...
updated: "2026-04-07"
8f: "F5_call"
keywords: [parser construction, tools parser, parser, builder, examples, production tools, data sources, tool permissions, interim validation
...
```bash
python _tools/cex_score.py --apply bld-tools-parser.md
```
...
| bld_tools_runtime_rule | sibling | 0.64 |
