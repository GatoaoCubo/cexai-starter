---
id: p11_fb_eval_dataset
kind: builder_default
pillar: P11
title: "Feedback: Eval Dataset"
domain: eval_dataset
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, eval_dataset]
8f: "F7_govern"
keywords: [eval dataset, never rules, failure modes, step correction, feedback, anti-patterns, eval_dataset, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for eval dataset builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
