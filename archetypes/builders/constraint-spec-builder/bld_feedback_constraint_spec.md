---
id: p11_fb_constraint_spec
kind: builder_default
pillar: P11
title: "Feedback: Constraint Spec"
domain: constraint_spec
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, constraint_spec]
8f: "F7_govern"
keywords: [constraint spec, never rules, failure modes, step correction, feedback, anti-patterns, constraint_spec, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for constraint spec builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
