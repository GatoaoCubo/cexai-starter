---
quality: null
id: p11_fb_session_state
kind: builder_default
pillar: P11
title: "Feedback: Session State"
domain: session_state
version: 1.1.0
tags: [feedback, anti-patterns, P11, session_state]
8f: "F7_govern"
keywords: [session state, never rules, failure modes, step correction, feedback, anti-patterns, session_state, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for session state builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
