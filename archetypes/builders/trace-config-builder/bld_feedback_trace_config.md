---
quality: null
id: p11_fb_trace_config
kind: builder_default
pillar: P11
title: "Feedback: Trace Config"
domain: trace_config
version: 1.1.0
tags: [feedback, anti-patterns, P11, trace_config]
8f: "F7_govern"
keywords: [trace config, never rules, failure modes, step correction, feedback, anti-patterns, trace_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for trace config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
