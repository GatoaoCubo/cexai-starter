---
id: p11_fb_dual_loop_architecture
kind: builder_default
pillar: P11
title: "Feedback: Dual Loop Architecture"
domain: dual_loop_architecture
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, dual_loop_architecture]
8f: "F7_govern"
keywords: [dual loop architecture, never rules, failure modes, step correction, feedback, anti-patterns, dual_loop_architecture, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for dual loop architecture builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
related:
  ...
  - p11_fb_kind
  - p11_fb_pattern
  - p11_fb_model_architecture
---
# Feedback: Dual Loop Architecture
...
| [[p11_fb_model_architecture]] | sibling | 0.80 |
