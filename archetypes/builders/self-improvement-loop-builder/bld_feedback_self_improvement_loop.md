---
quality: null
id: p11_fb_self_improvement_loop
kind: builder_default
pillar: P11
title: "Feedback: Self Improvement Loop"
domain: self_improvement_loop
version: 1.1.0
tags: [feedback, anti-patterns, P11, self_improvement_loop]
8f: "F7_govern"
keywords: [self improvement loop, never rules, failure modes, step correction, feedback, anti-patterns, self_improvement_loop, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for self improvement loop builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
