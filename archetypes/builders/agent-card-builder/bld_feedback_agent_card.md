---
id: p11_fb_agent_card
kind: builder_default
pillar: P11
title: "Feedback: Agent Card"
domain: agent_card
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent_card]
8f: "F7_govern"
keywords: [agent card, never rules, failure modes, step correction, feedback, anti-patterns, agent_card, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agent card builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
| p11_fb_pipeline_template | sibling | 0.79 |
| p11_fb_model_card | sibling | 0.79 |
