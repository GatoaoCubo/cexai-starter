---
quality: null
id: p11_fb_path_config
kind: builder_default
pillar: P11
title: "Feedback: Path Config"
domain: path_config
version: 1.1.0
tags: [feedback, anti-patterns, P11, path_config]
8f: "F7_govern"
keywords: [path config, never rules, failure modes, step correction, feedback, anti-patterns, path_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for path config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
