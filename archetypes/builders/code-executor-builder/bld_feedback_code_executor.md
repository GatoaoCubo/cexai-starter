---
id: p11_fb_code_executor
kind: builder_default
pillar: P11
title: "Feedback: Code Executor"
domain: code_executor
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, code_executor]
8f: "F7_govern"
keywords: [code executor, never rules, failure modes, step correction, feedback, anti-patterns, code_executor, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for code executor builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
