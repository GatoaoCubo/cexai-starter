---
quality: null
id: p11_fb_terminal_backend
kind: builder_default
pillar: P11
title: "Feedback: Terminal Backend"
domain: terminal_backend
version: 1.1.0
tags: [feedback, anti-patterns, P11, terminal_backend]
8f: "F7_govern"
keywords: [terminal backend, never rules, failure modes, step correction, feedback, anti-patterns, terminal_backend, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for terminal backend builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
