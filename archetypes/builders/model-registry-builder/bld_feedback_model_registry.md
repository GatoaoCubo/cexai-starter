---
quality: null
id: p11_fb_model_registry
kind: builder_default
pillar: P11
title: "Feedback: Model Registry"
domain: model_registry
version: 1.1.0
tags: [feedback, anti-patterns, P11, model_registry]
8f: "F7_govern"
keywords: [model registry, never rules, failure modes, step correction, feedback, anti-patterns, model_registry, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for model registry builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
| [[p11_fb_user_model]] | sibling | 0.80 |
