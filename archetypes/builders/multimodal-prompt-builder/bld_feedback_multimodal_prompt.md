...
8f: "F7_govern"
keywords: [multimodal prompt, never rules, failure modes, step correction, feedback, anti-patterns, multimodal_prompt, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for multimodal prompt builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
