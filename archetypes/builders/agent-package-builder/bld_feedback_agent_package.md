---
id: p11_fb_agent_package
kind: builder_default
pillar: P11
title: "Feedback: Agent Package"
domain: agent_package
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, agent_package]
8f: "F7_govern"
keywords: [agent package, never rules, failure modes, step correction, feedback, anti-patterns, agent_package, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for agent package builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
