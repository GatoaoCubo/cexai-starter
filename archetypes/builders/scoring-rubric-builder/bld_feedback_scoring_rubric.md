...
8f: "F7_govern"
keywords: [scoring rubric, never rules, failure modes, step correction, feedback, anti-patterns, scoring_rubric, common failure modes, failure mode, correction protocol]
