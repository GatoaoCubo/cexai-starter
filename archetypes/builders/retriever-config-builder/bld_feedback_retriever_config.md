...
8f: "F7_govern"
keywords: [retriever config, retriever config feedback, regression signals, and quality improvement triggers, feedback, anti-patterns, retriever_config, common failure modes, correction protocol, key behaviors]
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
## Common Failure Modes for Retriever Config
