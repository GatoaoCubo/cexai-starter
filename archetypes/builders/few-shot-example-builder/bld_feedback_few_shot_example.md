---
id: bld_feedback_few_shot_example
kind: builder_default
pillar: P11
title: "Feedback: Few Shot Example"
version: 1.1.0
domain: few_shot_example
quality: null
tags: [feedback, anti-patterns, P11, few_shot_example, builder, correction]
llm_function: GOVERN
8f: "F7_govern"
keywords: [few shot example, never rules, failure modes, step correction, feedback, anti-patterns, few_shot_example, builder, correction, common failure modes]
density_score: 0.88
created: "2026-04-17"
updated: "2026-04-22"
author: builder
tldr: "Anti-patterns and correction protocol for few_shot_example builders. 6 NEVER rules + 4 failure modes + 3-step correction."
related:
  - p11_fb_quality_gate
  - p11_fb_pattern
  - p11_fb_kind
...
| p11_fb__builder | sibling | 0.79 |
| [[p11_fb_context_file]] | sibling | 0.79 |
