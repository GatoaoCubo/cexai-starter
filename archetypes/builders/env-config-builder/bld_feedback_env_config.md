---
id: p11_fb_env_config
kind: builder_default
pillar: P11
title: "Feedback: Env Config"
domain: env_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, env_config]
8f: "F7_govern"
keywords: [env config, never rules, failure modes, step correction, feedback, anti-patterns, env_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for env config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
