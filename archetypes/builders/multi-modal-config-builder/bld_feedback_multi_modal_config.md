---
quality: null
id: p11_fb_multi_modal_config
kind: builder_default
pillar: P11
title: "Feedback: Multi Modal Config"
domain: multi_modal_config
version: 1.1.0
tags: [feedback, anti-patterns, P11, multi_modal_config]
8f: "F7_govern"
keywords: [multi modal config, never rules, failure modes, step correction, feedback, anti-patterns, multi_modal_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for multi modal config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
