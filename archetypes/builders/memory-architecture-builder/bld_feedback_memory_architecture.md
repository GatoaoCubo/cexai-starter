---
quality: null
id: p11_fb_memory_architecture
kind: builder_default
pillar: P11
title: "Feedback: Memory Architecture"
domain: memory_architecture
version: 1.1.0
tags: [feedback, anti-patterns, P11, memory_architecture]
8f: "F7_govern"
keywords: [memory architecture, never rules, failure modes, step correction, feedback, anti-patterns, memory_architecture, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for memory architecture builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
