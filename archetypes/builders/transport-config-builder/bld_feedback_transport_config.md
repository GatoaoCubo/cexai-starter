---
quality: null
id: p11_fb_transport_config
kind: builder_default
pillar: P11
title: "Feedback: Transport Config"
domain: transport_config
version: 1.1.0
tags: [feedback, anti-patterns, P11, transport_config]
8f: "F7_govern"
keywords: [transport config, never rules, failure modes, step correction, feedback, anti-patterns, transport_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for transport config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
