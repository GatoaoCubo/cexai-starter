---
quality: null
id: p11_fb_vector_store
kind: builder_default
pillar: P11
title: "Feedback: Vector Store"
domain: vector_store
version: 1.1.0
tags: [feedback, anti-patterns, P11, vector_store]
8f: "F7_govern"
keywords: [vector store, never rules, failure modes, step correction, feedback, anti-patterns, vector_store, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for vector store builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
