---
id: p11_fb_compression_config
kind: builder_default
pillar: P11
title: "Feedback: Compression Config"
domain: compression_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, compression_config]
8f: "F7_govern"
keywords: [compression config, never rules, failure modes, step correction, feedback, anti-patterns, compression_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for compression config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
