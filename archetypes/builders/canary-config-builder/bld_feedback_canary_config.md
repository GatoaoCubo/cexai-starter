---
id: p11_fb_canary_config
kind: builder_default
pillar: P11
title: "Feedback: Canary Config"
domain: canary_config
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, canary_config]
8f: "F7_govern"
keywords: [canary config, never rules, failure modes, step correction, feedback, anti-patterns, canary_config, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for canary config builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
