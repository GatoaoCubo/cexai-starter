---
quality: null
id: p11_fb_stt_provider
kind: builder_default
pillar: P11
title: "Feedback: Stt Provider"
domain: stt_provider
version: 1.1.0
tags: [feedback, anti-patterns, P11, stt_provider]
8f: "F7_govern"
keywords: [stt provider, never rules, failure modes, step correction, feedback, anti-patterns, stt_provider, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for stt provider builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
...
related:
  - p11_fb_quality_gate
  - p11_fb_pattern
  - p11_fb_model_provider
  - p11_fb_context_file
  - p11_fb_api_reference
---
# Feedback: Stt Provider
...
| [[p11_fb_model_provider]] | sibling | 0.80 |
