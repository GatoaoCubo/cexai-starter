---
id: p11_fb_deployment_manifest
kind: builder_default
pillar: P11
title: "Feedback: Deployment Manifest"
domain: deployment_manifest
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, deployment_manifest]
8f: "F7_govern"
keywords: [deployment manifest, never rules, failure modes, step correction, feedback, anti-patterns, deployment_manifest, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for deployment manifest builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
