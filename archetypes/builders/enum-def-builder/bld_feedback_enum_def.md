...
pillar: P11
title: "Feedback: Enum Def"
domain: enum_def
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, enum_def]
8f: "F7_govern"
keywords: [enum def, never rules, failure modes, step correction, feedback, anti-patterns, enum_def, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for enum def builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
