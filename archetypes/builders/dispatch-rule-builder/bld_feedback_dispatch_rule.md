---
id: p11_fb_dispatch_rule
kind: builder_default
pillar: P11
title: "Feedback: Dispatch Rule"
domain: dispatch_rule
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, dispatch_rule]
8f: "F7_govern"
keywords: [dispatch rule, never rules, failure modes, step correction, feedback, anti-patterns, dispatch_rule, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for dispatch rule builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
