---
id: p11_fb_eval_metric
kind: builder_default
pillar: P11
title: "Feedback: Eval Metric"
domain: eval_metric
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, eval_metric]
8f: "F7_govern"
keywords: [eval metric, never rules, failure modes, step correction, feedback, anti-patterns, eval_metric, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for eval metric builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
