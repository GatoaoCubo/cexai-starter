---
id: p11_fb_action_prompt
kind: builder_default
pillar: P11
title: "Feedback: Action Prompt"
domain: action_prompt
version: 1.1.0
quality: null
tags: [feedback, anti-patterns, P11, action_prompt]
8f: "F7_govern"
keywords: [action prompt, never rules, failure modes, step correction, feedback, anti-patterns, action_prompt, common failure modes, failure mode, correction protocol]
tldr: "Anti-patterns and correction protocol for action prompt builders. 6 NEVER rules + 4 failure modes + 3-step correction."
author: builder
llm_function: GOVERN
density_score: 0.88
created: "2026-04-17"
