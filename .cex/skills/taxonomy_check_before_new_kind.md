...
description: Run the 5-question composability test before introducing any new kind so the 318-kind taxonomy stays intentional and gaps are filled by composition first.
when:
