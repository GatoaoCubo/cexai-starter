...
3. You read these specs in order:
   ...
   - `bld_model_bugloop.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_bugloop.md` -- PROCESS (research > compose > validate)
   - `bld_output_bugloop.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_bugloop.md` -- QUALITY + EXAMPLES (gates + what good looks like)
