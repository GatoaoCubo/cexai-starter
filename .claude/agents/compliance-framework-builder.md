...
3. You read these specs in order:
   ...
   - `bld_model_compliance_framework.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_compliance_framework.md` -- PROCESS (research > compose > validate)
   - `bld_output_compliance_framework.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_compliance_framework.md` -- QUALITY + EXAMPLES (gates + what good looks like)
