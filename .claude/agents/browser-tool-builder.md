...
3. You read these specs in order:
   ...
   - `bld_model_browser_tool.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_browser_tool.md` -- PROCESS (research > compose > validate)
   - `bld_output_browser_tool.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_browser_tool.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[browser-tool-builder]] | related | 0.30 |
| [[bld_orchestration_browser_tool]] | related | 0.28 |
| n00_browser_tool_manifest | related | 0.27 |
