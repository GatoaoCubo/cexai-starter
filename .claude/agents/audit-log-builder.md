...
3. You read these specs in order:
   ...
   - `bld_model_audit_log.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_audit_log.md` -- PROCESS (research > compose > validate)
   - `bld_output_audit_log.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_audit_log.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[n00_audit_log_manifest]] | related | 0.27 |
| [[bld_tools_audit_log]] | related | 0.26 |
