...
3. You read these specs in order:
   ...
   - `bld_model_pricing_page.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_pricing_page.md` -- PROCESS (research > compose > validate)
   - `bld_output_pricing_page.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_pricing_page.md` -- QUALITY + EXAMPLES (gates + what good looks like)
