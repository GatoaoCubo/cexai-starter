...
3. You read these specs in order:
   ...
   - `bld_model_retriever.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_retriever.md` -- PROCESS (research > compose > validate)
   - `bld_output_retriever.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_retriever.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[retriever-builder]] | related | 0.26 |
