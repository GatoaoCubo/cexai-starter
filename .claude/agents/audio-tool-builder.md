...
3. You read these specs in order:
   ...
   - `bld_model_audio_tool.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_audio_tool.md` -- PROCESS (research > compose > validate)
   - `bld_output_audio_tool.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_audio_tool.md` -- QUALITY + EXAMPLES (gates + what good looks like)
