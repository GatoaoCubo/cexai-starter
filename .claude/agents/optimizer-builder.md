...
3. You read these specs in order:
   ...
   - `bld_model_optimizer.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_optimizer.md` -- PROCESS (research > compose > validate)
   - `bld_output_optimizer.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_optimizer.md` -- QUALITY + EXAMPLES (gates + what good looks like)
