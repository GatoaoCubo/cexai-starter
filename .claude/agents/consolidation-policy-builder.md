...
3. You read these specs in order:
   ...
   - `bld_model_consolidation_policy.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_consolidation_policy.md` -- PROCESS (research > compose > validate)
   - `bld_output_consolidation_policy.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_consolidation_policy.md` -- QUALITY + EXAMPLES (gates + what good looks like)
