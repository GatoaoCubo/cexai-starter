...
3. You read these specs in order:
   ...
   - `bld_model_case_study.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_case_study.md` -- PROCESS (research > compose > validate)
   - `bld_output_case_study.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_case_study.md` -- QUALITY + EXAMPLES (gates + what good looks like)
