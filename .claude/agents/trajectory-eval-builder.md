...
3. You read these specs in order:
   ...
   - `bld_model_trajectory_eval.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_trajectory_eval.md` -- PROCESS (research > compose > validate)
   - `bld_output_trajectory_eval.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_trajectory_eval.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_config_trajectory_eval]] | related | 0.32 |
