...
| Description | Agent mental model (routing, decisions) |
...
3. You read these specs in order:
   ...
   - `bld_model_mental_model.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_mental_model.md` -- PROCESS (research > compose > validate)
   - `bld_output_mental_model.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_mental_model.md` -- QUALITY + EXAMPLES (gates + what good looks like)
