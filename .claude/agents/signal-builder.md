...
3. You read these specs in order:
   ...
   - `bld_model_signal.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_signal.md` -- PROCESS (research > compose > validate)
   - `bld_output_signal.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_signal.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_collaboration_signal]] | related | 0.28 |
