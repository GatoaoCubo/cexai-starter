...
3. You read these specs in order:
   ...
   - `bld_model_context_doc.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_context_doc.md` -- PROCESS (research > compose > validate)
   - `bld_output_context_doc.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_context_doc.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
|----------|-------------|-------|
| [[context-doc-builder]] | related | 0.34 |
| [[p03_sp_builder_nucleus]] | related | 0.32 |
| [[kind-builder]] | related | 0.32 |
| [[bld_collaboration_context_doc]] | related | 0.27 |
