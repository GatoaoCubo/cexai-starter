...
3. You read these specs in order:
   ...
   - `bld_model_rbac_policy.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_rbac_policy.md` -- PROCESS (research > compose > validate)
   - `bld_output_rbac_policy.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_rbac_policy.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_config_rbac_policy]] | related | 0.27 |
