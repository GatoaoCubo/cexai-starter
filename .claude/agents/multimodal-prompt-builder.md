...
3. You read these specs in order:
   ...
   - `bld_model_multimodal_prompt.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_multimodal_prompt.md` -- PROCESS (research > compose > validate)
   - `bld_output_multimodal_prompt.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_multimodal_prompt.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_tools_multimodal_prompt]] | related | 0.28 |
