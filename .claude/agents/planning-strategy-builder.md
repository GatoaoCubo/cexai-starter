...
3. You read these specs in order:
   ...
   - `bld_model_planning_strategy.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_planning_strategy.md` -- PROCESS (research > compose > validate)
   - `bld_output_planning_strategy.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_planning_strategy.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[p01_kc_pillar_brief_p03_prompt_en]] | related | 0.29 |
| [[bld_config_planning_strategy]] | related | 0.28 |
