...
3. You read these specs in order:
   ...
   - `bld_model_dataset_card.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_dataset_card.md` -- PROCESS (research > compose > validate)
   - `bld_output_dataset_card.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_dataset_card.md` -- QUALITY + EXAMPLES (gates + what good looks like)
