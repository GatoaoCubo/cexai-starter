...
3. You read these specs in order:
   ...
   - `bld_model_invariant.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_invariant.md` -- PROCESS (research > compose > validate)
   - `bld_output_invariant.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_invariant.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| n00_invariant_manifest | related | 0.30 |
