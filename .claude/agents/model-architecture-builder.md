...
3. You read these specs in order:
   ...
   - `bld_model_model_architecture.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_model_architecture.md` -- PROCESS (research > compose > validate)
   - `bld_output_model_architecture.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_model_architecture.md` -- QUALITY + EXAMPLES (gates + what good looks like)
