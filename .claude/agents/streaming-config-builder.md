...
3. You read these specs in order:
   ...
   - `bld_model_streaming_config.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_streaming_config.md` -- PROCESS (research > compose > validate)
   - `bld_output_streaming_config.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_streaming_config.md` -- QUALITY + EXAMPLES (gates + what good looks like)
