...
3. You read these specs in order:
   ...
   - `bld_model_rate_limit_config.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_rate_limit_config.md` -- PROCESS (research > compose > validate)
   - `bld_output_rate_limit_config.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_rate_limit_config.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[rate-limit-config-builder]] | related | 0.31 |
| [[bld_orchestration_rate_limit_config]] | related | 0.28 |
