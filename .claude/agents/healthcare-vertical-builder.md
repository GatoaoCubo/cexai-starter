...
3. You read these specs in order:
   ...
   - `bld_model_healthcare_vertical.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_healthcare_vertical.md` -- PROCESS (research > compose > validate)
   - `bld_output_healthcare_vertical.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_healthcare_vertical.md` -- QUALITY + EXAMPLES (gates + what good looks like)
