...
3. You read these specs in order:
   ...
   - `bld_model_search_tool.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_search_tool.md` -- PROCESS (research > compose > validate)
   - `bld_output_search_tool.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_search_tool.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
|----------|-------------|-------|
| [[search-tool-builder]] | related | 0.37 |
| [[bld_collaboration_search_tool]] | related | 0.32 |
