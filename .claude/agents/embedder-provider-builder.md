...
3. You read these specs in order:
   ...
   - `bld_model_embedder_provider.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_embedder_provider.md` -- PROCESS (research > compose > validate)
   - `bld_output_embedder_provider.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_embedder_provider.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_orchestration_embedder_provider]] | related | 0.28 |
| p01_kc_pillar_brief_p02_model_en | related | 0.28 |
| [[bld_orchestration_model_provider]] | related | 0.28 |
