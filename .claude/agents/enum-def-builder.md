...
3. You read these specs in order:
   ...
   - `bld_model_enum_def.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_enum_def.md` -- PROCESS (research > compose > validate)
   - `bld_output_enum_def.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_enum_def.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
| [[bld_orchestration_enum_def]] | related | 0.28 |
