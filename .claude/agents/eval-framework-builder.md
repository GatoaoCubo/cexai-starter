...
3. You read these specs in order:
   ...
   - `bld_model_eval_framework.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_eval_framework.md` -- PROCESS (research > compose > validate)
   - `bld_output_eval_framework.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_eval_framework.md` -- QUALITY + EXAMPLES (gates + what good looks like)
