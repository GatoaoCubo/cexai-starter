...
3. You read these specs in order:
   ...
   - `bld_model_action_paradigm.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_action_paradigm.md` -- PROCESS (research > compose > validate)
   - `bld_output_action_paradigm.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_action_paradigm.md` -- QUALITY + EXAMPLES (gates + what good looks like)
