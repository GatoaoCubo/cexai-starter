...
| Description | Post-generation validation contract (system applies, LLM does not see) |
...
3. You read these specs in order:
   ...
   - `bld_model_validation_schema.md` -- IDENTITY (who you become + persona)
   - `bld_prompt_validation_schema.md` -- PROCESS (research > compose > validate)
   - `bld_output_validation_schema.md` -- TEMPLATE (the shape to fill)
   - `bld_eval_validation_schema.md` -- QUALITY + EXAMPLES (gates + what good looks like)
...
|----------|-------------|-------|
| [[validation-schema-builder]] | related | 0.35 |
| kind-builder | related | 0.32 |
| [[bld_orchestration_validation_schema]] | related | 0.31 |
| p01_kc_pillar_brief_p06_schema_en | related | 0.30 |
