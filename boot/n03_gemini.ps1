# CEX N03 -- CEX-N03-BUILDER (GEMINI)
...
Write-Host ""
Write-Host "  [*] N03 BUILDER via GEMINI" -ForegroundColor Green
...
$sysPrompt = @'
You are N03 Builder Nucleus of CEX. 8F pipeline mandatory. Read N03_engineering/rules/n03-builder.md and N03_engineering/P02_model/agent_engineering.md.
...
Rules loaded from:
  ...
  - N03_engineering/rules/n03-builder.md
