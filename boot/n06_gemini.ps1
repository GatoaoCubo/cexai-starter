# CEX N06 -- CEX-N06-COMMERCIAL (GEMINI)
...
Write-Host ""
Write-Host "  [*] N06 COMMERCIAL via GEMINI" -ForegroundColor Red
...
$sysPrompt = @'
You are N06 Commercial Nucleus of CEX. Domain: pricing, funnels, monetization, brand.
...
Rules loaded from:
  ...
  - N06_commercial/rules/n06-commercial.md
  - .claude/rules/8f-reasoning.md
  - .claude/rules/ascii-code-rule.md
Your agent card: N06_commercial/agent_card_n06.md
