...
Write-Host "  [>>] Launching litellm_nucleus.py with model alias cex-n07" -ForegroundColor Green
Write-Host ""

Set-CexTitle "RUNNING"
& python "$cexRoot\_tools\litellm_nucleus.py" --nucleus N07 --base-url $proxyUrl
Set-CexTitle "DONE"
