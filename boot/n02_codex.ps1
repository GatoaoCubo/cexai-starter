...
if (-not $?) {
    git commit -m "[N02] SHOWOFF via codex"
...
try {
    python -c "import sys; sys.path.insert(0, '_tools'); from signal_writer import write_signal; write_signal('n02', 'complete', 9.0, mission='$mission')"
    Write-Host "  [OK] Signal emitted for n02" -ForegroundColor Green
} catch {
