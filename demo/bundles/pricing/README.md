# CEXAI capability bundle: Pricing (`pricing`)

The **12 pillar contract** for the `content_monetization` kind, plus the setup config.
Nucleus N06 . kind `content_monetization` . pillar P11.
...
becomes a working Pricing agent.
...
generic, public builder contract for `content_monetization` -- no tenant data.
