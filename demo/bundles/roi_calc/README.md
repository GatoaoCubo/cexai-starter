# CEXAI capability bundle: ROI Calculator (`roi_calc`)

The **12 pillar contract** for the `roi_calculator` kind, plus the setup config.
...
becomes a working ROI Calculator agent.
...
generic, public builder contract for `roi_calculator` -- no tenant data.
