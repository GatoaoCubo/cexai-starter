# CEXAI capability bundle: Sourcing Opportunity Matrix (`sourcing_opportunity`)

The **12 pillar contract** for the `opportunity_matrix` kind, plus the setup config.
...
becomes a working Sourcing Opportunity Matrix agent.
...
generic, public builder contract for `opportunity_matrix` -- no tenant data.
