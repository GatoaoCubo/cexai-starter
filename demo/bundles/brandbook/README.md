# CEXAI capability bundle: Brand Book (`brandbook`)

The **12 pillar contract** for the `brandbook` kind, plus the setup config.
Nucleus N06 . kind `brandbook` . pillar P05.
...
becomes a working Brand Book agent.
...
generic, public builder contract for `brandbook` -- no tenant data.
