...
Setup do bundle CEXAI `research` (Research) em Gemini Gems. Este bundle não
...
O Gem deve responder com um artefato `knowledge_card` (brief estruturado,
com fontes e um veredito de confiança) na voz de marca configurada.
...
- **O Gem inventa dado, preço ou fonte** -> reforce nas
...
- **A saída não parece um `knowledge_card`** -> confirme que os 12 arquivos
  P0X foram carregados como Knowledge (o Gem usa `P01_knowledge.md` +
