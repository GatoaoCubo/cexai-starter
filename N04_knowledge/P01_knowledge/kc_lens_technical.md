...
| nucleus ([[p01_kc_agent]]) | Autonomous agent with specialized role, domain, tools, sin-driven objective |
...
| RAG ([[p01_kc_embedding_config]]) | TF-IDF + Haiku reranking on 3647-doc corpus; Phase 0 MCP for external context; hybrid retrieval (dense + sparse) fused via RRF |
